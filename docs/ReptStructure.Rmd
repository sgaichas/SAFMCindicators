...
A Climate Vulnerability Analysis for Bering Sea species has been published, however its direct use in management processes is unclear... The Climate Ready Synthesis recommended inclusion of climate vulnerability information in status reports/risk assessments; perhaps this is being done?
...
The Pacific Council a single ESR produced annually for the California Current ecoregion, consisting of a graphical summary and ~40 page main report with many detailed appendices for indciators and methods. Additional appendices are included for both short term and long term ecological and climate forecasts. Forecast uncertainty and evaluation of previous forecasts are included. 
...
CVA exists and is proposed for use as a component in the process determining ABC uncertainty buffers (see below).
...
Manages with 5 place-based Fishery Ecosystem Plans established in 2010: Hawaii, American Samoa, Mariana, Pacific remote islands, Pelagic. Online organization places fishery and protected species management on the same page for each FEP. Council guiding principles include promoting an ecosystem approach. 

An ESR for Hawaii with the same geographic scope as FEP was last produced in 2022. It includes socioeconomic, fisheries, coral reef, climate, human impact, and coral reef climate vulnerability sections. Identifies cumulative impacts. Aspects on nearshore fisheries included at the request of the Council. Habitat recovery depends on both land based and fishery management. 

Has the Council seen this? Do they use it?

State is using layers on [cumulative impacts](https://www.arcgis.com/home/item.html?id=ca750b9476fb429b809d1300628f3bb7), habitat efforts are also using the information. 

Have regional ecosystem advisory committees REACs include land based activities. 

CVAs are by species group and unclear what spatial scale? 
