...
The New England Council region includes  
...
Up until 2022, the Caribbean Council managed under region-wide FMPs for spiny lobster, queen conch, reef fish, and corals (with a prohibition on coral take). Three Island-Based FMPs for Puerto Rico, St. Croix, and St. Thomas/St. John were initiated to address management issues unique to each island and to lay the groundwork for place-based EBFM; these Island-Based FMPs have been used for management since October 2022. The FMPs all refer to EBFM as the overarching management principle, and include goals and objectives related both to fishery stock management and sustainable ecosystem services.
...
The Caribbean Council is one of three regional Councils served by SEFSC, the other two are the Gulf and South Atlantic. While SEFSC dedicates staff resources to ecosystem reporting, resources to date have been inadequate to produce annual ecosystem reports (or stock assessments) across all three regions. 
