...
This document outlines 9 policies and 9 research and information needs. Research needs are re-aligned with policies here and then aligned with existing indicators in the following table.
...
FWcrosswalk <- data.frame(Policy = c("Forage Fisheries",
                          ...
                          Indicator = c("Forage stock abundance and dynamics for important forage by FMP (Appendix A)",
