...
For example, Nassau grouper () were identified as a species with a very high vulnerability ranking and a negative impact directionality in the CVA. Individual species sensitivity data shows high vulerability to both temeperature and ocean acidification. 
