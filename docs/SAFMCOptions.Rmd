...
The SSC briefly discussed the SAFMC food web model and its capabilities to inform ecosystem importance. This is expanded with an example of potential use below. 

The SSC also discussed how information in the South Atlantic Climate Vulnerability Assessment [@craig_climate_2025] might be applied to the climate change attribute. This is also expanded in an example below. 
...
```{r pMSE, fig.cap="New England protoype MSE structure, reprinted from https://d23h0vhsm26o6d.cloudfront.net/pMSE-Final-Report2.pdf", out.width="75%"}
...
### Operating Model 
The existing SAFMC full food web model (South Atlantic Region (SAR) EwE Model) is an excellent starting point for an operating model, because it already includes species interactions, and versions of it have already been reviewed and endorsed by the SAFMC SSC. This model serves as the basis for the SAR MICE (model of intermediate complexity) focused on the Snapper Grouper complex (SAFMC EwE MICE Model Technical Report June 2022, and [SSC Report October 2021](https://safmc.net/documents/a08b_ewe_red-snapper-workshop-findings-october-ssc_revised-pdf/)). The SAR EwE model could be modified as outlined below to serve as an operating model for estimating and evaluating multispecies reference points for different species complexes.   
...
Based on the review of all U.S. Fishery Management Council's ecosystem data and current approaches, including SAFMC's 
