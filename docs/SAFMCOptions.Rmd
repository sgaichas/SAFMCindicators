...
```{r eMOLT, fig.cap="Comparison of electronic monitoring on lobster trap and trawlers (eMOLT) data with modeled ocean bottom temperature from 13 March 2026. Source: weekly eMOLT update email, George Maynard, eMOLT coordinator"}
