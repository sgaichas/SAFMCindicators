...
The indicators include data for all temperatures from 0 to 30 degrees C in 1 degree increments. Another indicator showing the proportion of area for different depth ranges above the threshold was also produced and can be presented. 

Maps can be zoomed in to show more detailed areas as well. For example, the number of days with bottom temperature over 25 degrees C or 77 degrees F was greater in 2020 than in other years on the shelf near the Charleston Bump Complex.
...
p2 <- btthermalcompzoom(filename = file.names[2], daysabove = 25)
