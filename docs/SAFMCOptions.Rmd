...
Reviewed current SAFMC risk policy and ABC approach, and evaluated the feasibility of adapting other Council approaches given existing ESR and CVA data. 

While some Councils use information from annual stock level Ecosystem and Socioeconomic Profiles [@behan_ecosystem_2022; @shotwell_synthesizing_2022; @shotwell_introducing_2023], others are developing a more streamlined process based on structured discussions between stock assessors and ecosystem scientists. This approach will be explored for the South Atlantic context. 

Potential approaches were discussed with the SSC in April 2026. 
