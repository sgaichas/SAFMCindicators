...
Existing ecosystem data products for the South Atlantic should be consulted before initiating new indicator or product development. The ESR and CVA contain a wealth of useful information that aligns well with existing SAFMC policy. Priority indicators can be 
...
MSEs are likewise useful and resource intensive. 


## Potential next steps 

A key decision is which of these options to consider and how to develop actionable management using ecosystem information. A structured decision process such as those outlined in the Pacific (Ecosystem initiatives), North Pacific (Action modules), Mid-Atlantic (EAFM decision process), and Gulf (Fishery Ecosystem Initiatives) Council FEPs could help manage these options and ensure the SAFMC proceeds in a manner best suited to regional needs. Therefore, the first step may be to outline this type of actionable process for the SAFMC. 
