...
A project is in progress to develop fishery species CVA for this region (see below). Marine mammal (108 stocks) and highly migratory species (58 stocks) climate vulnerability has been assessed for the entire Atlantic Coast including the Caribbean [@lettrich_vulnerability_2023; @loughran_climate_2025]. While Caribbean stocks of dolphins and whales are included in the marine mammal CVA, nearshore marine mammals such as manatees are not. While fishing communities in the region have not been specifically assessed, climate vulnerability of US Caribbean communities was considered in the [Fifth National Climate Assessment](https://secasc.ncsu.edu/wp-content/uploads/sites/178/2025/07/NCA5_Ch23_US-Caribbean.pdf), finding high vulnerability from increasing exposure to extreme weather such as hurricanes combined with the concentration of communities and infrastructure in vulnerable areas [@mendez-lazaro_chapter_2023]. 
...
The recently developed RAF incorporates ESR indicators and other sources of information into a decision support tool that scores risks from ecological change, socioeconomic pressure, and degraded habitats to management outcomes. The RAF report includes a risk score sheet with instructions, as well as documentation of all indicators and methods, with detailed descriptions of how to use the RAF in management decisions along with four case studies. The document also outlines potential development of ecosystem-level indicators. 
...
CFMC staff identified the ongoing FEP process as a key success, with many innovative approaches tailored to regional management needs and information, that has been progressively moving through the Council process. The stakeholder-driven conceptual models
risk assessment framework (RAF) represents a considerable success in outlining an operational framework to use ecosystem indicators from the ESR and other sources. 

Successes and Challenges
Ongoing FEP process is a success, many innovations, moving through the Council
Conceptual models
Risk assessment (Liajay will send)
New ESR a success! First in the region, but see below on e.g. temp indicators
SEDAR 103 will examine alternative methods for reference points at the ecosystem and species group level
Ongoing IRA projects are making good progress, will have results by 2027
National level indicators are often not compatible with needs in the Caribbean region, or leave out the region as noted above for economic information
Recreational fisheries data collection an ongoing challenge, don't even have MRIP anymore
Habitat diversity combined with different jurisdiction boundaries make management measures difficult to reconcile and limit which can be used
EEZ begins 9 nmi off PR, 3 nmi off USVI
This is the deep area below diving range which limits both data and options for returning fish that managers dont want caught
Left with time closures and cant use things like size limits
State waters and federal different rules for some key things
Need to see if there is an updated food web; these started in tropical areas but resources to update have been low
Ciguatera poisoning is a big challenge currently managed by not allowing sale of certain high trophic level large species and setting federal ABC to 0 for them due to food web magnification of toxins from the benthic dinoflagellate Gambierdiscus found in shallow reef habitats. However it has shown up in other species recently. 
Has economic impacts, difficult to measure it easily in captured fish. 
Unlike red tide or other HABs, cant see it
Likely an issue off the coast of FL in the SA as well, and predicted to increase with climate warming
Management across state and fed and between federal agencies remains challenging
Marine protected areas still had to prohibit trawling
HAPC areas
SST is important but not telling the whole story; bottom temperature is what affects the deepwater species reproduction and recruitment and that info is missing
Ongoing issues getting the data needed for analyses; even federal agencies withhold some data and research results that the Council could use in management sooner
Infrastructure to obtain and manage data locally needed


Potential innovations/what to do differently
Potential for SEDAR 103 to innovate on system and multispecies reference points sorely needed in this context
