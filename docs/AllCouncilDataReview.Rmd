...
Considerable work has been completed in the Southeast US region that forms an excellent starting point to evaluate South Atlantic resources relative to those available nationwide. The South Atlantic has an ESR [@craig_ecosystem_2021], CVAs for fish [@burton_climate_2023; @craig_climate_2025] and fishing communities [@seara_community_2022], well-developed processes to integrate stakeholder ecosystem knowledge [@mcpherson_participatory_2022], and the results of a joint workshop that identified data sources for ecosystem indicators throughout the U.S. East Coast [@saba_summary_2023]. Marine mammal climate vulnerability has also been assessed for the entire Atlantic Coast [@lettrich_vulnerability_2023]. These documents contain indicators that represent a starting point towards meeting the needs identified in the EFH policy documents above. 
