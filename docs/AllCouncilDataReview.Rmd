...
Successes and Challenges
Having the FEI process in place is a success: although not yet fully finalized due to the shutdown, the Council has approved the process
Appealing FEP aspect is then FEI's tangible way to address specific ecosystem issues
IRA project in progress will elicit stakeholder views on ecosystem issues to get a fuller picture of public concerns that could feed into the FEI process
Workshops with participatory modeling
AI scraping blogs, forums, social media for issues
FEI process identifies gaps and could also integrate with Council research priorities
Likely different working groups needed for individual FEIs, process TBD but may distribute across subset of Ecosystem Technical Committee, NMFS, and Council staff
Challenging stakeholder perception that including ecosystem factors always results in more restrictions 
Could do more messaging around how the red tide inclusion affects quotas
Will also need to manage expectations around other ecosystem info use
ESRs only 2 and out of date, Council would like regular reporting
Finding specific on ramps for using information: can it impact season length, bag limit, size limit, quota?

Potential innovations/what to do differently
Annual ecosystem reporting at least for a while until they get a sense of what is changing in the system and how quickly
Looking forward to a stripped down set of indicators that are automated to regularly update as just done for Caribbean report
May be able to see patterns that indicate where to bring ecosystem information into the management process

Interesting to note
Gulf not experiencing the same cross boundary distribution shifts as the Atlantic Councils: tropicalization is more of an issue
Other ecosystem issues besides red tide: 
Depredations
King mackerel changing seasonality due to temperature? Or fishery change?
Regulatory discard
Hypoxia in TX
