...
# tell which python to use, system specific
...
First we try producing the NEUS thermal_habitat_gridded indicator to validate the workflow. All of the hardcoded file paths in the original code need to be changed for this anyway. This code is modified from [make_GLORYS_bt_soe.R](https://github.com/NEFSC/READ-EDAB-GLORYS/blob/main/vignettes/make_GLORYS_bt_soe.R):
...
Now I am getting the plots I expected. 
...
Produced output for thermal habitat area, but it looks wrong, maybe a daily file again
...
```{r}
  ...
  # writeCDF(test.sds,here::here('data','SOE','thermal_habitat_checker.nc'))
   ...
   fix <- bttib |>
     dplyr::select(Longitude = longitude, Latitude = latitude, Value = nday_20)
...
Now to investigate why thermal habitat is breaking for the South Atlantic

This is the thermal habitat function `EDAB.GLORYS::make_thermal_habitat_gridded`
